...
SHARED_OBJS = \
    ...
    $(BUILD)/udp.o $(BUILD)/tcp.o $(BUILD)/http.o $(BUILD)/http_parse.o $(BUILD)/http_date.o $(BUILD)/http_chunk.o \
...
FUZZ_ASM_OBJS = \
    ...
    $(BUILD)/http.o $(BUILD)/http_parse.o $(BUILD)/http_date.o $(BUILD)/http_chunk.o $(BUILD)/net_cfg.o $(BUILD)/timer_hw.o \
