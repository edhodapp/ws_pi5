...
FUZZ_ASM_OBJS = $(BUILD)/net.o $(BUILD)/eth.o $(BUILD)/arp.o $(BUILD)/ip.o $(BUILD)/ip_reasm.o $(BUILD)/icmp.o $(BUILD)/udp.o $(BUILD)/tcp.o $(BUILD)/net_cfg.o $(BUILD)/timer_hw.o $(BUILD)/timer_pool.o $(BUILD)/ntp.o
